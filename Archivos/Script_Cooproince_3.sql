...
-- -----------------------------------------------------
-- Table `sc_cooproince`.`CONFIG_PROCESOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`CONFIG_PROCESOS` (
  `id_configProcesos` INT NOT NULL AUTO_INCREMENT,
  `ini_actual` INT NOT NULL,
  `mes_anio_actual` INT NOT NULL,
  PRIMARY KEY (`id_configProcesos`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`ROL` (
  ...
  `nombre` VARCHAR(45) NOT NULL,
  `descripcion` VARCHAR(45) NULL,
  `CONFIG_PROCESOS_id_configProcesos` INT NULL,
  `verPefil_usuario` INT NOT NULL,
  `aparecerEnbusqueda` INT NOT NULL,
  PRIMARY KEY (`id_rol`),
  INDEX `fk_ROL_CONFIG_PROCESOS1_idx` (`CONFIG_PROCESOS_id_configProcesos` ASC),
  CONSTRAINT `fk_ROL_CONFIG_PROCESOS1`
    FOREIGN KEY (`CONFIG_PROCESOS_id_configProcesos`)
    REFERENCES `sc_cooproince`.`CONFIG_PROCESOS` (`id_configProcesos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sc_cooproince`.`DURACION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`DURACION` (
  `id_duracion` INT NOT NULL AUTO_INCREMENT,
  `nb_duracion` VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`PRODUCCION` (
  ...
  INDEX `fk_PRODUCCION_DURACION1_idx` (`DURACION_id_duracion` ASC),
  ...
  CONSTRAINT `fk_PRODUCCION_USUARIO1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PRODUCCION_DURACION1`
    FOREIGN KEY (`DURACION_id_duracion`)
    REFERENCES `sc_cooproince`.`DURACION` (`id_duracion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`PARENTESCO` (
  ...
  `id_animalesIndiv` INT NULL,
  `id_animalesIndiv1` INT NULL,
  `id_tipoParentesco` INT NULL,
...
-- -----------------------------------------------------
-- Table `sc_cooproince`.`PROCESOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`PROCESOS` (
  `id_proceso` INT NOT NULL AUTO_INCREMENT,
  `nb_proceso` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`id_proceso`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sc_cooproince`.`BITACORA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sc_cooproince`.`BITACORA` (
  `id_bitacora` INT NOT NULL AUTO_INCREMENT,
  `codigo_bitacora` VARCHAR(45) NOT NULL,
  `id_usuario` INT NOT NULL,
  `id_proceso` INT NOT NULL,
  `Accion` VARCHAR(100) NOT NULL,
  `Fecha` DATE NOT NULL,
  `Hora` TIME NOT NULL,
  `PROCESOS_id_proceso` INT NULL,
  `USUARIO_id_usuario` INT NULL,
  PRIMARY KEY (`id_bitacora`),
  INDEX `fk_BITACORA_PROCESOS1_idx` (`PROCESOS_id_proceso` ASC),
  INDEX `fk_BITACORA_USUARIO1_idx` (`USUARIO_id_usuario` ASC),
  CONSTRAINT `fk_BITACORA_PROCESOS1`
    FOREIGN KEY (`PROCESOS_id_proceso`)
    REFERENCES `sc_cooproince`.`PROCESOS` (`id_proceso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
